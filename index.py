...
from src.find import get_sightings, find_location_by_city_name, find_location_by_gps_coordinates, find_location_from_ip
...
# parser.add_argument('--infer', '-i', action='store_true', help='infer location from ip')
...
if args.infer is not None:
    location = find_location_from_ip()
    print('The closest location found was {city}'.format(city=location['full_location']))
